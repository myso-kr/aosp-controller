...
var ControllerDeviceChrome = exports.ControllerDeviceChrome = function () {
  var _ref21 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee22(adb, serial, rooted) {
    var port, cacheList, caches, cache, crowner;
    return regeneratorRuntime.wrap(function _callee22$(_context22) {
      while (1) {
        switch (_context22.prev = _context22.next) {
          case 0:
            _context22.t0 = parseInt;
            _context22.t2 = _lodash2.default;
            _context22.t3 = _lodash2.default;
            _context22.next = 5;
            return adb.listForwards(serial);

          case 5:
            _context22.t4 = _context22.sent;
            _context22.t5 = { remote: 'localabstract:chrome_devtools_remote' };
            _context22.t6 = _context22.t3.find.call(_context22.t3, _context22.t4, _context22.t5);
            _context22.t1 = _context22.t2.get.call(_context22.t2, _context22.t6, 'local', "").replace(/[^\d]/g, '');
            ...
            _context22.t1 = _lodash2.default.random(9223, 9323);

          case 11:
            _context22.t7 = _context22.t1;
            port = (0, _context22.t0)(_context22.t7);
          ...
          case 18:
            _context22.next = 20;
            return adb.shellWait(serial, 'su -c \'echo "*/20 * * * * reboot" > /sdcard/android/crontabs/root\' root');
          ...
          case 29:
            _context22.t8 = _context22.sent.toString().trim();
          ...
          case 38:
            return _context22.abrupt('return', adb.chrome(serial, { port: port }));
  ...
  return function ControllerDeviceChrome(_x23, _x24, _x25) {
...
exports.default = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(adb, serial, rooted) {
    var _this = this;

    var chrome, Runtime, Network, Page, Emulation, DOM, Input, chromeDeviceEmulation, chromeDeviceEmulationSwipe, chromeDeviceEmulationTouch, chromeDeviceEmulationTouchElement, chromeDeviceEmulationInput, chromeDeviceEmulationGoBack, action, keywords, ks;
        ...
        switch (_context20.prev = _context20.next) {
          ...
          case 3:
                ...
                return regeneratorRuntime.wrap(function _callee6$(_context6) {
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      ...
                      case 2:
                        metrics = _context6.sent;
                        cx = metrics.layoutViewport.clientWidth / 2;
                        cy = metrics.layoutViewport.clientHeight / 2;
                        mx = cx / 3;
                        my = cy / 3;
                        _context6.t0 = options.direction.toLowerCase();
                        _context6.next = _context6.t0 === 'd' ? 10 : _context6.t0 === 'down' ? 10 : _context6.t0 === 'u' ? 17 : _context6.t0 === 'up' ? 17 : _context6.t0 === 'r' ? 24 : _context6.t0 === 'right' ? 24 : _context6.t0 === 'l' ? 31 : _context6.t0 === 'left' ? 31 : 38;
                        break;
                      ...
                      case 12:
                        _context6.next = 14;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(ratio) {
                            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  ...
                                  case 2:
                                    _context2.next = 4;
                                    return _bluebird2.default.delay(_lodash2.default.random(10, 70));
                      ...
                      case 19:
                        _context6.next = 21;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(ratio) {
                      ...
                      case 26:
                        _context6.next = 28;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(ratio) {
                      ...
                      case 33:
                        _context6.next = 35;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(ratio) {
            ...
            chromeDeviceEmulationTouch = function () {
                  ...
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      ...
                      case 5:
                        ...
                        return _context7.abrupt('return', chromeDeviceEmulationTouchWhile({ nodeId: options.random ? _lodash2.default.sample(elements.nodeIds) : _lodash2.default.nth(elements.nodeIds, 0) }, options));
              ...
              return function chromeDeviceEmulationTouch(_x11) {
                return _ref8.apply(this, arguments);
              };
            }();

            chromeDeviceEmulationTouchElement = function () {
              var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(element) {
                var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                ...
                return regeneratorRuntime.wrap(function _callee12$(_context12) {
                  while (1) {
                    switch (_context12.prev = _context12.next) {
                      ...
                      case 2:
                        metrics = _context12.sent;
                        _context12.next = 5;
                        return DOM.getBoxModel(element);

                      case 5:
                        elementBox = _context12.sent;
                        ...
                        _context12.t0 = true;
                        _context12.next = _context12.t0 === !boundingT ? 19 : _context12.t0 === !boundingB ? 28 : _context12.t0 === !boundingL ? 37 : _context12.t0 === !boundingR ? 46 : 55;
                        break;
                      ...
                      case 21:
                        _context12.next = 23;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(ratio) {
                      ...
                      case 30:
                        _context12.next = 32;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(ratio) {
                      ...
                      case 39:
                        _context12.next = 41;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(ratio) {
                      ...
                      case 48:
                        _context12.next = 50;
                        return _bluebird2.default.mapSeries((0, _easing2.default)(_lodash2.default.random(10, 20), 'linear'), function () {
                          var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(ratio) {
              ...
              return function chromeDeviceEmulationTouchElement(_x13) {
                return _ref9.apply(this, arguments);
              };
            }();

            chromeDeviceEmulationInput = function () {
              var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(selector) {
                var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                    ...
                    switch (_context17.prev = _context17.next) {
                      ...
                      case 4:
                        ...
                        return _bluebird2.default.mapSeries(chars, function () {
                          var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(char, offset) {
                              ...
                              while (1) {
                                switch (_context16.prev = _context16.next) {
                                  case 0:
                                    ...
                                    return _context16.abrupt('return', _bluebird2.default.resolve()
                                    // KeyDown
                                    .then(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13() {
                                    ...
                                    }))).delay(_lodash2.default.random(10, 30))
                                    // Composition
              ...
              return function chromeDeviceEmulationInput(_x19) {
                  ...
                  while (1) {
                    switch (_context18.prev = _context18.next) {
                      ...
                      case 2:
                        ...
                        _context18.next = 5;
                        return Page.navigateToHistoryEntry({ entryId: _lodash2.default.nth(history.entries, history.currentIndex - options.offset).id });
            ...
            _context20.prev = 11;
            action = 0;
            keywords = _lodash2.default.uniqBy(KEYWORDS_INTEREST, 'keyword');
            ks = [];
          ...
          case 27:
            _context20.next = 29;
            return Page.loadEventFired(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19() {
              var offset, k;
                ...
                while (1) {
                  switch (_context19.prev = _context19.next) {
                    ...
                    case 7:
                      ...
                      _context19.next = 10;
                      return chromeDeviceEmulationTouch('.total_wrap a.total_tit', { random: true });
                    ...
                    case 10:
                      ...
                      _context19.next = 13;
                      return _bluebird2.default.mapSeries(_lodash2.default.range(_lodash2.default.random(10, 30)), function () {
                        return chromeDeviceEmulationSwipe('d');
                      });

                    case 13:
                      _context19.next = 15;
                      return chromeDeviceEmulationGoBack();
